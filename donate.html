...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      ...
      <div class="container">
        <div class="row">
        	<div class="col-lg-4 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
              <img src="images/bg_7.jpg" height="140px" alt="">
        			<div class="d-flex mb-4">
        				<!-- <div class="img" style="background-image: url(images/bg_7.jpg);"></div> -->
        				<div class="info ml-4">
        					<h3><a href="teacher-single.html">Geoffrey</a></h3>
        					<span class="position">Primary Seven </span>
        					<div class="text">
		        				<p>Donate <span>$10</span> for <a href="#">Each Child </a></p>
		        			</div>
        				</div>
        			</div>
        		</div>
          ...
          <div class="col-lg-6 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
        			<div class="d-flex mb-4">
        				<div class="img" style="background-image: url(images/bg_7.jpg);"></div>
        				<div class="info ml-4">
        					<h3><a href="teacher-single.html">Food Supplies</a></h3>
        					<span class="position">Support the needy to have the blessings to eat food</span>
        					<div class="text">
		        				<p>Donate <span>$10</span> for <a href="#">Each Child </a></p>
		        			</div>
        				</div>
    ...
    <section class="ftco-section-3 img" style="background-image: url(images/bg_7.jpg);">
    	<div class="overlay"></div>
    	<div class="container">
    		<div class="row d-md-flex">
    		<div class="col-md-6 d-flex ftco-animate">
    			<div class="img img-2 align-self-stretch" style="background-image: url(images/bg_7.jpg);"></div>
    		</div>
