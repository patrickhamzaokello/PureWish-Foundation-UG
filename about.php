...
@media (min-width: 600px) {
  .cards { grid-template-columns: repeat(3, 2fr); }
}
          ...
          <div class="col-md-4 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 d-flex services p-3 py-4 d-block">
              ...
              <div class="media-body pl-6">
                ...
                <p> To actively engage in empowering and Spiritual mentorship to children, youths and women for global change and leading sustainable development..</p>
              </div>
            </div>      
          </div>
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 d-flex services p-3 py-4 d-block">
              ...
              <div class="media-body pl-3">
                ...
                <p>To empower and transform humanity to build for the future</p>
              </div>
            </div>      
          </div>
          <div class="col-md-4 d-flex align-self-stretch ftco-animate">
...
<br>
    <div class="cards">
      ...
      <div class="card">
        <img src="images/1234.jpeg" style="border-radius: none;" height="200px" alt="">
        <h5>Angwech Elizabeth</h5>
        <span class="position title-color">Accountant</span>
      </div>
      <div class="card">
        <img src="images/123.jpeg" style="border-radius: none;" height="200px" alt="">
        <h5>Achieng Grace</h5>
      ...
      <div class="card">
        <img src="images/staff4.jpg" style="border-radius: none;" height="200px" alt="">
        ...
        <div class="row mb-5">
          <div class="col-md-3">
            <div class="ftco-footer-widget mb-4">
              ...
              <p>Purewish Foundation Uganda (PFU) is an indigenous not for profit Christian Organization with a mission to empower and transform humanity to build for the future</p>
          ...
          <div class="col-md-4">
            <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url(images/projects/4.JPG);"></a>
                <div class="text">
          ...
          <div class="col-md-2">
             <div class="ftco-footer-widget mb-4 ml-md-4">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="sponsored.html" class="py-2 d-block">Sponsor a Child</a></li>
            ...
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                ...
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+256 394 010 416</span></a></li>
