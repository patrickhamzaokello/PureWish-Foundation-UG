...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sponsorname = mysqli_real_escape_string($db, $_POST['sponsorname']);
    $sponsoremail = mysqli_real_escape_string($db, $_POST['sponsoremail']);
    $sponsoramount = mysqli_real_escape_string($db, $_POST['sponsoramount']);
    $sponsormessage = mysqli_real_escape_string($db, $_POST['sponsormessage']);
